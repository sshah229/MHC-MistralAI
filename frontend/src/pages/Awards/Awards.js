      ...
      <div className="w-full">
        <div className="p-6 bg-slate-900/80 border-b border-white/10">
          ...
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-semibold text-slate-200">{userCoins} Coins</h1>
          </div>
          </div>
        </div>
        
        <div className="p-4">
          <h1 className="font-semibold text-2xl mb-4 mt-4 text-slate-200">
            Redeem your coins for amazing fitness rewards!
          </h1>
          
          <div className="w-1/2 mb-8">
            <h1 className="text-lg font-semibold mb-3 text-slate-300">
            ...
            <ProgressBar 
              ...
              labelColor="#ffffff"
            />
            <p className="text-sm text-slate-400 mt-2">Complete more activities to earn additional coins!</p>
          </div>
          ...
          <div className="flex flex-row flex-wrap justify-evenly gap-8">
            {loading ? (
              <div role="status" className="flex items-center justify-center w-full py-20">
                <svg
                  aria-hidden="true"
                  className="w-12 h-12 mr-2 text-slate-600 animate-spin fill-teal-500"
                  viewBox="0 0 100 101"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
              ...
              rewards.map((reward) => (
                <div key={reward.id} className="w-[300px] bg-slate-900/80 border border-white/10 rounded-2xl p-4 flex flex-col items-center hover:border-white/20 transition-all duration-300">
                  ...
                  <h1 className="mt-2 text-xl font-semibold text-center text-slate-200">{reward.title}</h1>
                  <div className="mt-3 flex items-center bg-slate-800/80 px-4 py-2 rounded-full">
                    <svg 
                    ...
                    <h1 className="text-lg font-medium text-yellow-400">{reward.coins} coins</h1>
                  </div>
